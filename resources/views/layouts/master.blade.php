			...
			<div class="sidebar-wrapper scrollbar scrollbar-inner">
				<div class="sidebar-content">
					...
					<ul class="nav nav-primary">
						...
						<li class="nav-item {{ isActive('livros.create') }}{{ isActive('livros.index') }}">
							<a data-toggle="collapse" href="#livro" class="collapsed" aria-expanded="false">
								<i class="fas fa-book"></i>
								<p>Livros </p>
								<span class="caret"></span>
							</a>
							
							<div class="collapse {{ request()->is('livros*') ? 'show' : '' }}" id="livro">
								<ul class="nav nav-collapse ">
									<li class="{{ request()->is('livros/create') ? 'active' : '' }}">
										<a href="{{route('livros.create')}}">
											<span class="sub-item">Cadastrar</span>
									
										</a>
									</li>
									<li class="{{ request()->is('livros') ? 'active' : '' }}">
						...
						<li class="nav-item {{ isActive('categorias.create') }}{{ isActive('categorias.index') }}">
							<a data-toggle="collapse" href="#Cadastrar" class="collapsed" aria-expanded="false">
								<i class="fas fa-layer-group"></i>
								<p>Categorias </p>
								<span class="caret"></span>
							</a>
			
							<div class="collapse {{ request()->is('categorias*') ? 'show' : '' }}" id="Cadastrar">
								<ul class="nav nav-collapse ">
									<li class="{{ request()->is('categorias/create') ? 'active' : '' }}">
